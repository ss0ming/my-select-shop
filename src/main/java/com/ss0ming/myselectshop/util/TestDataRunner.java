package com.ss0ming.myselectshop.util;
...
import com.ss0ming.myselectshop.naver.service.NaverApiService;
import com.ss0ming.myselectshop.repository.ProductRepository;
import com.ss0ming.myselectshop.repository.UserRepository;
import com.ss0ming.myselectshop.service.UserService;
...
import static com.ss0ming.myselectshop.service.ProductService.MIN_MY_PRICE;
...
public class TestDataRunner implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        // 테스트 User 생성
        User testUser = new User("ssomings", passwordEncoder.encode("1234"), "ssomings@star.com", UserRoleEnum.USER);
